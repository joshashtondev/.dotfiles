...
static struct key keys_landscape_special[] = {
  ...
  {"(", "(", 0.5, Code, KEY_9},
  {")", ")", 0.5, Code, KEY_0},
  {"[", "[", 0.5, Code, KEY_LEFTBRACE},
  {"]", "]", 0.5, Code, KEY_RIGHTBRACE},
  {"{", "{", 0.5, Code, KEY_LEFTBRACE},
  {"}", "}", 0.5, Code, KEY_RIGHTBRACE},
  {"\\", "\\", 0.75, Code, KEY_BACKSLASH},
  {"|", "|", 0.75, Code, KEY_BACKSLASH},
  {";", ";", 1.0, Code, KEY_SEMICOLON},
  {":", ":", 1.0, Code, KEY_SEMICOLON},
  {"'", "'", 1.0, Code, KEY_APOSTROPHE},
  ...
  {"↑", "↑", 1.5, Code, KEY_UP},
  {"↓", "↓", 1.5, Code, KEY_DOWN},
  {"PgUp", "PgUp", 0.5, Code, KEY_PAGEUP},
  {"PgDn", "PgDn", 0.5, Code, KEY_PAGEDOWN},
  {"_", "_", 1.0, Code, KEY_MINUS},
  {"+", "+", 1.0, Code, KEY_EQUAL},
  {"<", "<", 1.0, Code, KEY_COMMA},
  {">", ">", 1.0, Code, KEY_DOT},
  {"/", "/", 1.0, Code, KEY_SLASH},
